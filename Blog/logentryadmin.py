...
class LogEntryAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ([f.name for f in LogEntry._meta.fields] + ['object_link', 'action_description', 'user_link', 'get_change_message'])
    fieldsets = (
        (ugettext_lazy('Metadata'), {'fields': ('action_time', 'user_link', 'action_description', 'object_link')}),
        (ugettext_lazy('Details'), {'fields': ('get_change_message', 'content_type', 'object_id', 'object_repr')}),
    )
    ...
    object_link.short_description = ugettext_lazy('object')
    ...
    user_link.short_description = ugettext_lazy('user')
    ...
    action_description.short_description = ugettext_lazy('action')

    def get_change_message(self, obj):
        return obj.get_change_message()

    get_change_message.short_description = ugettext_lazy('change message')
